...
def bbvsb_contract() -> None:
    ...
    pending = block(POL, "f$cc_turn_delayed_cbet_3w_bbvsb_completed_draw_translation_pending")
    assert "f$cc_turn_delayed_cbet_turn_completed" in pending
    assert "f$cc_turn_delayed_cbet_no_made" in pending
    assert "f$cc_real_frontdoor_draw" in pending

    air = block(POL, "f$cc_turn_delayed_cbet_3w_bbvsb_air_action")
    assert "f$cc_turn_delayed_cbet_3w_bbvsb_completed_draw_translation_pending Return false Force" in air
    ...
    assert "!f$cc_turn_delayed_cbet_3w_bbvsb_completed_draw_translation_pending" in covered
    unresolved = block(POL, "f$cc_turn_delayed_cbet_3w_extra_unresolved")
    assert "f$cc_turn_delayed_cbet_3w_bbvsb_completed_draw_translation_pending" in unresolved
